							...
							<li class="menu-item current">
								...
								<div class="submenu">
									<ul>
										...
										<li class="menu-item current"><a href="404.html">404 Page</a></li>
									</ul>
								</div>
							</li>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-5">
						<p id="page-title" class="h1">Error 404 - not found</p>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-md-8 col-md-offset-2">
							...
							<a class="custom-btn medium dark-color" href="index.html" data-text="Back to Home"><span>Back to Home</span></a>
						</div>
					</div>
				</div>
			</section>
