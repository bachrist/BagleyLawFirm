					...
					<nav id="navigation" role="navigation">
						<ul>
							<li class="menu-item">
								...
								<div class="submenu">
									<ul>
										<li class="menu-item"><a href="index.html">Home Style 1</a></li>
										<li class="menu-item"><a href="../style_2/index.html" target="_blank">Home Style 2</a></li>
										<li class="menu-item"><a href="../landing/index.html" target="_blank">One Page</a></li>
									</ul>
								</div>
							</li>
							<li class="menu-item">
								<a href="javascript:void(0);">We are</a>

								<div class="submenu">
									<ul>
										<li class="menu-item"><a href="about.html">About</a></li>
										<li class="menu-item"><a href="team_1.html">Team</a></li>
										<li class="menu-item"><a href="team_2.html">Team 2</a></li>
										<li class="menu-item"><a href="team_single.html">Team Single</a></li>
									</ul>
								</div>
							</li>
							...
							<li class="menu-item current">
								...
								<div class="submenu">
									<ul>
										<li class="menu-item"><a href="practices_1.html">Practices</a></li>
										<li class="menu-item"><a href="practices_2.html">Practices 2</a></li>
										<li class="menu-item"><a href="practices_details.html">Practice Single</a></li>
										...
										<li class="menu-item current">
											...
											<div class="submenu">
												<ul>
													<li class="menu-item"><a href="gallery_2.html">Gallery 3 Columns</a></li>
													<li class="menu-item current"><a href="gallery_1.html">Gallery 4 Columns</a></li>
												</ul>
											</div>
										</li>
							...
							<li class="menu-item"><a href="contacts.html">Feedback</a></li>
						</ul>
					</nav>
			...
			<section id="s-portfolio" class="section transparent">
				<div class="container">
					<ul id="option-set">
						...
						<li><a data-cat="category-1" href="#">Court Hearings</a></li>
						<li><a data-cat="category-2" href="#">Justice</a></li>
						<li><a data-cat="category-3" href="#">Criminal Law</a></li>
					</ul>

					<div class="portfolio-container portfolio-four-columns portfolio-style-1">
						<div class="portfolio-container--inner">
							<div class="row js-isotope" data-isotope-options='{ "itemSelector": ".element", "transitionDuration": "0.8s", "percentPosition": "true"}'>
								<div class="element category-1 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/1.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/1.jpg" data-gallery="gall"><span>Bankruptcy</span></a>
										</div>
									</div>
								</div>

								<div class="element category-2 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/2.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/2.jpg" data-gallery="gall"><span>Bilateral Agreement</span></a>
										</div>
									</div>
								</div>

								<div class="element category-3 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/3.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/3.jpg" data-gallery="gall"><span>Legal Action</span></a>
										</div>
									</div>
								</div>
								...
								<div class="element category-3 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/4.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/4.jpg" data-gallery="gall"><span>Legal Action</span></a>
										</div>
									</div>
								</div>
								...
								<div class="element category-2 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/5.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/5.jpg" data-gallery="gall"><span>Assessment of Damage</span></a>
										</div>
									</div>
								</div>
								...
								<div class="element category-1 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/6.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/6.jpg" data-gallery="gall"><span>Mortgage</span></a>
										</div>
									</div>
								</div>
								...
								<div class="element category-1 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/7.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/7.jpg" data-gallery="gall"><span>Patent Pending</span></a>
										</div>
									</div>
								</div>
								...
								<div class="element category-2 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/8.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/8.jpg" data-gallery="gall"><span>Industrial Property</span></a>
										</div>
									</div>
								</div>
								...
								<div class="element category-3 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/9.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/9.jpg" data-gallery="gall"><span>Probate administration</span></a>
										</div>
									</div>
								</div>
								...
								<div class="element category-3 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/10.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/10.jpg" data-gallery="gall"><span>Wrongful death</span></a>
										</div>
									</div>
								</div>
								...
								<div class="element category-2 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/11.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/11.jpg" data-gallery="gall"><span>Guardinship</span></a>
										</div>
									</div>
								</div>
								...
								<div class="element category-1 col-xs-12 col-sm-6 col-md-4 col-lg-3">
									<div class="portfolio-item center-block">
										<div class="inner">
											<figure class="img-wrap">
												<img src="../img/portfolio_img/4_col/12.jpg" alt="demo" />
											</figure>

											<a class="h3" href="../img/portfolio_img/4_col/12.jpg" data-gallery="gall"><span>Construction Law</span></a>
										</div>
									</div>
								</div>
							</div>
